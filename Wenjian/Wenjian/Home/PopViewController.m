...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.mainArray = @[@{@"title":@"电脑传输",@"image":@"pop_computer"},@{@"title":@"手机互传",@"image":@"pop_iphone"},@{@"title":@"相册导入",@"image":@"pop_photos"},@{@"title":@"扫一扫",@"image":@"pop_scan"},@{@"title":@"网页搜索",@"image":@"pop_search"}];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.imageView setImage:[UIImage imageNamed:[dict objectForKey:@"image"]]];
    return cell;
}
