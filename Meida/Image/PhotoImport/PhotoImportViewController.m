...
+ (instancetype)allocFromStoryBoard {
    ...
    PhotoImportViewController *VC = [mediaStory instantiateViewControllerWithIdentifier:@"PhotoImportViewController"];
    return VC;
}
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [MobClick beginLogPageView:@"photoimport"];
}
- (void)viewWillDisappear:(BOOL)animated
{
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"photoimport"];
}
/*
